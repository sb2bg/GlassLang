...
public class NumberPrimitive extends Primitive<Double> {
	...
	public Primitive<?> add(Primitive<?> other)
	{
		...
		throw new RuntimeError("Right hand of operation '+' must be number or string", context);
	}
	...
	public NumberPrimitive div(Primitive<?> other)
	{
		...
		if (value.getValue() == 0)
		{
			throw new RuntimeError("Division by 0", context);
		}
	...
	public Primitive<?> mul(Primitive<?> other)
	{
		...
		throw new RuntimeError("Right hand of operation '*' must be a number or string", context);
	}
	...
	public Primitive<?> mod(Primitive<?> other)
	{
		...
		throw new RuntimeError("Right hand of operation '%' must be a number", context);
	}
